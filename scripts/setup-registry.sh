...
echo "  SSH_PRIVATE_KEY    = <CI 专用私钥内容>"
  # 建议: ssh-keygen -t ed25519 -C "fin-trace-ci" 生成新密钥对
  # 公钥: cat ~/.ssh/fin-trace-ci.pub | ssh deployer@182.61.1.77 "cat >> ~/.ssh/authorized_keys"
echo ""
echo "============================================"
